...
public:
     ...
     */
  Q_INVOKABLE  void get(const QString &url, const QHash<QString, QVariant> &params = QHash<QString, QVariant>());
     ...
     */
  Q_INVOKABLE  void post(const QString &url, const QByteArray &data);
...
signals:
     ...
     */
   Q_INVOKABLE void replyGetted(const QByteArray &reply);
